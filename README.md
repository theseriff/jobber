...
[Documentation](https://example.com) | [PyPI](https://pypi.org/project/jobber/)

</div>
<div style="display: flex; flex-wrap: wrap; justify-content: center; align-items: center; text-align: center;">

  [![PyPI version](https://badge.fury.io/py/jobber.svg)](https://badge.fury.io/py/jobber)
  [![Build Status](https://travis-ci.org/user/jobber.svg?branch=develop)](https://travis-ci.org/user/jobber)
