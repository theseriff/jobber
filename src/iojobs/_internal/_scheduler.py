...
from iojobs._internal._func_wrapper import FuncWrapper, create_default_name
...
class JobScheduler:
    ...
    def __init__(
        ...
        *,
        ...
        self._serializer: IOJobsSerializer = (
            serializer or AstLiteralSerializer()
        )
        self._durable: JobRepository = durable or SQLiteJobRepository()
        self._func_registered: dict[FuncID, Callable[..., Any]] = {}  # pyright: ignore[reportExplicitAny]
        self._jobs_registered: list[ScheduledJob[Any]] = []  # pyright: ignore[reportExplicitAny]
    ...
    def register(
        ...
        *,
        ...
        wrapper = self._wrapper(func_name=func_name)
        if callable(func):
            return wrapper(func)
        return wrapper
    ...
    def _wrapper(
        ...
        *,
        ...
        def inner(func: Callable[_P, _R]) -> FuncWrapper[_P, _R]:
            ...
            fwrapper = FuncWrapper(
                ...
                func_name=fname,
                original_func=func,
                executors_pool=self._executors,
            )
            self._func_registered[FuncID(fname)] = fwrapper
            return fwrapper
